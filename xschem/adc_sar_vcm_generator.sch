...
N 750 -860 750 -840 {
lab=VSS}
N 630 -1020 630 -770 {lab=VDD}
N 630 -630 630 -300 {lab=VSS}
...
C {adc_sar_noise_cell1.sym} 600 -720 0 0 {name=x_decap_[1..3]}
C {adc_sar_noise_cell1.sym} 980 -580 0 0 {name=x_cap1_[1..40]}
C {adc_sar_noise_cell1.sym} 980 -270 0 0 {name=x_cap2_[1..40]}
